...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiY2hoZXRyaSIsImEiOiJja2dvcHY2bmUwaW4yMnZtb3VuaDV0cWNpIn0.dT9quKMovetqUw-bEvsMeQ";
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(location.coordinates).addTo(map); // popup
...
if (mapBox) {
  var mapLocations = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displayMap)(mapLocations);
}
...
if (passwordDataForm) passwordDataForm.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var currentPassword, password, passwordConform;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConform = document.getElementById("password-confirm").value;
            _context.next = 7;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60027" + '/');
